      ...
      <div className="bg-gray-950 min-h-screen flex justify-center items-center ">
        <div className="text-white bg-gray-700 p-8  max-w-sm w-full shadow-2xl rounded-lg">
          <div className="mb-4">
            ...
            <p className="text-sm text-center">Join our community and start connecting.</p>
          </div>

          <form>
            <div className=" mb-4">
              <input className="p-3 border-2 border-gray-500 rounded-sm w-full focus:outline-none"
                type="email"
                id=""
          ...
          <div>
            <p className="text-blue-400 text-center">Already have an account? Sign in</p>
          </div>
